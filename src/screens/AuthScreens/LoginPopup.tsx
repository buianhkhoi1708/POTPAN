...
import styles from "../styles/page3-1b.styles";


type Props = NativeStackScreenProps<RootStackParamList, "Page3-1b">;

export default function Page3_1b({ route, navigation }: Props) {
