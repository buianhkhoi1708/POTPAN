...
const LanguageScreen: React.FC = () => {
  ...
  const languages = useMemo(
    () => [
      {
        id: "vi",
        label: t("language.names.vi"),
        nativeName: "Tiếng Việt",
        flag: "🇻🇳",
      },
      {
        id: "en",
        label: t("language.names.en"),
        nativeName: "English",
        flag: "🇺🇸",
      },
      {
        id: "zh",
        label: t("language.names.zh"),
        nativeName: "中文",
        flag: "🇨🇳",
      },
    ],
          ...
          <View style={styles.cardContent}>
            <View style={styles.cardLeft}>
              ...
              <View style={styles.textContainer}>
                <AppText
                  variant="bold"
                  style={[styles.languageName, { color: theme.primary_text }]}
                >
                  {item.label}
                </AppText>
                <AppText
                  style={[styles.nativeName, { color: theme.placeholder_text }]}
                >
                  {item.nativeName}
                </AppText>
              </View>
